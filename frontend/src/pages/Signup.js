...
import { FaEnvelope, FaLock, FaUser, FaPhone, FaUserPlus, FaFilm, FaEye, FaEyeSlash, FaMapMarkerAlt } from 'react-icons/fa';
        ...
        >
          ...
          <div className="hidden md:flex flex-col space-y-6 text-gray-900">
            <div className="inline-flex items-center space-x-2 rounded-full bg-purple-100 border border-purple-200 px-4 py-2 text-sm text-purple-600 w-max">
              ...
              <span>Join millions of movie lovers</span>
            </div>
            ...
            <p className="text-lg text-gray-600 max-w-md">
              Sign up to book tickets, create wishlists, get personalized recommendations, and join our amazing community of movie enthusiasts.
            </p>
            <div className="flex flex-wrap gap-3">
              <span className="px-4 py-2 rounded-full bg-gray-100 border border-gray-200 text-sm text-gray-700">🎬 Premium movies</span>
              <span className="px-4 py-2 rounded-full bg-gray-100 border border-gray-200 text-sm text-gray-700">🎫 Easy booking</span>
              <span className="px-4 py-2 rounded-full bg-gray-100 border border-gray-200 text-sm text-gray-700">⭐ Reviews</span>
              <span className="px-4 py-2 rounded-full bg-gray-100 border border-gray-200 text-sm text-gray-700">💬 Community</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign up with your basic details to get started</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      value={formData.city}
                      onChange={handleChange}
                      className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-200 transition-all duration-300 appearance-none"
                    >
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                <input type="checkbox" className="rounded border-gray-300 bg-white text-purple-600 focus:ring-purple-500" required />
